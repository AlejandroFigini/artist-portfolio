...
export const UI_TRANSLATIONS: Record<string, Record<Lang, string>> = {
  ...
  seek: { en: 'Seek', es: 'Avanzar', pt: 'Avançar', fr: 'Avancer' },
  ...
  field_date: { en: 'Date', es: 'Fecha', pt: 'Data', fr: 'Date' },
  field_project: { en: 'Project', es: 'Proyecto', pt: 'Projeto', fr: 'Projet' },
  field_description: { en: 'Description', es: 'Descripción', pt: 'Descrição', fr: 'Description' },
  field_role: { en: 'Role', es: 'Rol', pt: 'Papel', fr: 'Rôle' },
  field_artist: { en: 'Artist', es: 'Artista', pt: 'Artista', fr: 'Artiste' },
  view_original_post: { en: 'View original post', es: 'Ver publicación original', pt: 'Ver publicação original', fr: 'Voir la publication originale' },
