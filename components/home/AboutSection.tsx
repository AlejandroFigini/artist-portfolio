  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.to('.about-fig', { autoAlpha: 1, y: 0, duration: 0.4 }, 0)
        .to('.about-title', { autoAlpha: 1, y: 0, duration: 0.9 }, 0.1)
        .to('.about-lede', { autoAlpha: 1, y: 0, duration: 0.7 }, 0.4)
        ...
        .to('.about-bio p', { autoAlpha: 1, y: 0, duration: 0.7, stagger: 0.12 }, 0.8)
